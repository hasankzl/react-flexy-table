  ...
  return (
    <div >
      <table className={"rtf-table " + styles["rft-table"] + " " + className}>
        <Head keys={keys} filterable={filterable} filterVirtualData={filterVirtualData} handleQueries={handleQueries} sortVirtualData={sortVirtualData} nonFilterCols={nonFilterCols} nonSortCols={nonSortCols} additionalCols={additionalCols} sortable={sortable} />
